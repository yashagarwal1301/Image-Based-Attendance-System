...
# This part is image labels setting start 
        # first header image  
        img=Image.open(r"D:\Final Project\Images_GUI\banner.jpg")
        ...
        # backgorund image 
        bg1=Image.open(r"D:\Final Project\Images_GUI\bg3.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"D:\Final Project\Images_GUI\std1.jpg")
        std_img_btn=std_img_btn.resize((180,180),Image.ANTIALIAS)
        self.std_img1=ImageTk.PhotoImage(std_img_btn)

        std_b1 = Button(bg_img,command=self.student_pannels,image=self.std_img1,cursor="hand2")
        std_b1.place(x=360,y=100,width=180,height=180)
        ...
        std_b1_1.place(x=360,y=280,width=180,height=45)

        # Detect Face  button 2
        det_img_btn=Image.open(r"D:\Final Project\Images_GUI\det1.jpg")
        det_img_btn=det_img_btn.resize((180,180),Image.ANTIALIAS)
        self.det_img1=ImageTk.PhotoImage(det_img_btn)

        det_b1 = Button(bg_img,command=self.face_rec,image=self.det_img1,cursor="hand2",)
        det_b1.place(x=590,y=100,width=180,height=180)

        det_b1_1 = Button(bg_img,command=self.face_rec,text="Face Detector",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        det_b1_1.place(x=590,y=280,width=180,height=45)

         # Attendance System  button 3
        att_img_btn=Image.open(r"D:\Final Project\Images_GUI\att.jpg")
        ...
        # hlp_img_btn=Image.open(r"D:\Final Project\Images_GUI\hlp.jpg")
        ...
        # Start below buttons.........
         # Train   button 5
        tra_img_btn=Image.open(r"D:\Final Project\Images_GUI\tra1.jpg")
        tra_img_btn=tra_img_btn.resize((180,180),Image.ANTIALIAS)
        self.tra_img1=ImageTk.PhotoImage(tra_img_btn)

        tra_b1 = Button(bg_img,command=self.train_pannels,image=self.tra_img1,cursor="hand2",)
        tra_b1.place(x=360,y=350,width=180,height=180)

        tra_b1_1 = Button(bg_img,command=self.train_pannels,text="Data Train",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        tra_b1_1.place(x=360,y=530,width=180,height=45)

        # Photo   button 6
        # pho_img_btn=Image.open(r"D:\Final Project\Images_GUI\qr1.png")
        ...
        # Developers   button 7
        dev_img_btn=Image.open(r"D:\Final Project\Images_GUI\dev.jpg")
        ...
        dev_b1.place(x=590,y=350,width=180,height=180)

        dev_b1_1 = Button(bg_img,command=self.developr,text="Developers",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        dev_b1_1.place(x=590,y=530,width=180,height=45)

        # exit   button 8
        exi_img_btn=Image.open(r"D:\Final Project\Images_GUI\exi.jpg")
