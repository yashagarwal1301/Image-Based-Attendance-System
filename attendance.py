...
class Attendance:
    ...
    def __init__(self,root):
        ...
        #Student Roll
        student_roll_label = Label(left_frame,text="USN:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #create table 
        self.attendanceReport_left = ttk.Treeview(table_frame,column=("ID","USN","Name","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.attendanceReport_left.heading("USN",text="USN")
        ...
        self.attendanceReport_left.column("USN",width=100)
        ...
        #create table 
        self.attendanceReport = ttk.Treeview(table_frame,column=("ID","USN","Name","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        if self.var_id.get()=="" or self.var_roll.get=="" or self.var_name.get()=="" or self.var_time.get()=="" or self.var_date.get()=="" or self.var_attend.get()=="Status":
            ...
            try:
                ...
                if Update > 0:
                    ...
                    mycursor.execute("update stdattendance set std_id=%s,std_USN=%s,std_name=%s,std_time=%s,std_date=%s,std_attendance=%s where std_id=%s",( 
                    self.var_id.get(),
                    self.var_roll.get(),
                    self.var_name.get(),
                    self.var_time.get(),
    ...
    #             udate = i[4]
    #             uattend = i[5]
    #             qury = "INSERT INTO stdattendance(std_id, std_USN, std_name, std_time, std_date, std_attendance) VALUES(%s,%s,%s,%s,%s,%s)"
